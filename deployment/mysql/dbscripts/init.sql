...
CREATE TABLE IF NOT EXISTS REGISTRY_ORGANIZATION (
    ...
    DEFAULT_IMAGE_VISIBILITY VARCHAR(36)  DEFAULT "PUBLIC",
    CREATED_DATE             DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UNIQUE (ORG_NAME),
    PRIMARY KEY (ORG_UUID, ORG_NAME)
)
ENGINE = InnoDB
DEFAULT CHARSET = latin1;
...
CREATE TABLE IF NOT EXISTS REGISTRY_ORG_USER_MAPPING (
    ...
    FOREIGN KEY (ORG_UUID) REFERENCES REGISTRY_ORGANIZATION (ORG_UUID)
        ON DELETE CASCADE
)
ENGINE = InnoDB
DEFAULT CHARSET = latin1;
...
CREATE TABLE IF NOT EXISTS REGISTRY_ARTIFACT_IMAGE (
    ...
    VISIBILITY         VARCHAR(36)  DEFAULT "PUBLIC",
    PRIMARY KEY (ARTIFACT_IMAGE_ID),
    CONSTRAINT UC_ARTIFACT_IMG UNIQUE (ORG_UUID, IMAGE_NAME),
    FOREIGN KEY (ORG_UUID) REFERENCES REGISTRY_ORGANIZATION (ORG_UUID)
        ON DELETE CASCADE
)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS REGISTRY_ARTIFACT (
    ...
    LAST_AUTHOR       VARCHAR(255) DEFAULT "",
    USER_UUID         VARCHAR(255) DEFAULT "",
    METADATA          BLOB,
...
CREATE TABLE IF NOT EXISTS REGISTRY_ARTIFACT_LABELS (
    ARTIFACT_ID VARCHAR(36) NOT NULL,
