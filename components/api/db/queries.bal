...
public const string SEARCH_USER_ORGS_QUERY_IMAGE_COUNT = "SELECT REGISTRY_ORGANIZATION.ORG_NAME, COUNT(REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID) as Image_Count
                                    FROM REGISTRY_ORGANIZATION LEFT JOIN
                                    REGISTRY_ARTIFACT_IMAGE ON REGISTRY_ORGANIZATION.ORG_NAME=REGISTRY_ARTIFACT_IMAGE.ORG_NAME 
                                    WHERE (REGISTRY_ARTIFACT_IMAGE.VISIBILITY = \"PUBLIC\" OR REGISTRY_ARTIFACT_IMAGE.VISIBILITY is NULL) AND
