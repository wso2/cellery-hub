...
public const string DELETE_IMAGE_KEYWORDS_QUERY = "DELETE FROM IMAGE_KEYWORDS WHERE IMAGE_KEYWORDS.ARTIFACT_IMAGE_ID IN (SELECT ARTIFACT_IMAGE_ID 
                                    FROM REGISTRY_ARTIFACT_IMAGE WHERE IMAGE_NAME = ? AND ORG_NAME = ? AND ORG_NAME IN (SELECT ORG_NAME 
                                    FROM REGISTRY_ORG_USER_MAPPING WHERE USER_UUID = ? AND (USER_ROLE = \"PUSH\" OR USER_ROLE = \"ADMIN\"))) AND 
                                    KEYWORD <> \"\" AND ARTIFACT_IMAGE_ID <> \"\"";
...
public const string GET_USER_ROLE_QUERY = "SELECT USER_ROLE FROM REGISTRY_ORG_USER_MAPPING WHERE USER_UUID = ? AND ORG_NAME = ?";
