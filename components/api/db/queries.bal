...
public const string GET_IMAGE_FOR_USER_FROM_IMAGE_NAME = "SELECT REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID,ORG_NAME,
                                    IMAGE_NAME,REGISTRY_ARTIFACT_IMAGE.SUMMERY, REGISTRY_ARTIFACT_IMAGE.FIRST_AUTHOR,
...
public const string GET_IMAGE_FROM_IMAGE_NAME = "SELECT REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID,ORG_NAME,IMAGE_NAME,
                                    REGISTRY_ARTIFACT_IMAGE.SUMMERY, REGISTRY_ARTIFACT_IMAGE.FIRST_AUTHOR,VISIBILITY, SUM(PUSH_COUNT), 
...
public const string GET_ARTIFACTS_OF_IMAGE_FOR_USER = "SELECT REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID, REGISTRY_ARTIFACT.ARTIFACT_ID, 
                                    REGISTRY_ARTIFACT.SUMMERY, REGISTRY_ARTIFACT.PULL_COUNT,
...
public const string GET_ARTIFACTS_OF_PUBLIC_IMAGE = "SELECT REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID, REGISTRY_ARTIFACT.ARTIFACT_ID, REGISTRY_ARTIFACT.SUMMERY, 
...
public const string GET_ARTIFACT_FROM_IMG_NAME_N_VERSION = "SELECT REGISTRY_ARTIFACT.SUMMERY, REGISTRY_ARTIFACT.PULL_COUNT,
...
public const string GET_ARTIFACT_FOR_USER_FROM_IMG_NAME_N_VERSION = "SELECT REGISTRY_ARTIFACT.SUMMERY, REGISTRY_ARTIFACT.PULL_COUNT,
                                    REGISTRY_ARTIFACT.LAST_AUTHOR, REGISTRY_ARTIFACT.UPDATED_DATE, REGISTRY_ARTIFACT.METADATA
                                    FROM REGISTRY_ARTIFACT INNER JOIN
                                    REGISTRY_ARTIFACT_IMAGE ON REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID=REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID
...
public const string SEARCH_USER_ORGS_QUERY = "SELECT REGISTRY_ORGANIZATION.ORG_NAME, REGISTRY_ORGANIZATION.DESCRIPTION,
                                    ...
                                    FROM REGISTRY_ORGANIZATION LEFT JOIN
                                    REGISTRY_ORG_USER_MAPPING ON REGISTRY_ORGANIZATION.ORG_NAME=REGISTRY_ORG_USER_MAPPING.ORG_NAME
                                    WHERE REGISTRY_ORGANIZATION.ORG_NAME LIKE ? AND REGISTRY_ORG_USER_MAPPING.USER_UUID = ?
...
public const string SEARCH_PUBLIC_ORG_IMAGES_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.SUMMERY,
...
public const string SEARCH_ORG_IMAGES_FOR_USER_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.SUMMERY,
									SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS PULL_COUNT, MAX(REGISTRY_ARTIFACT.UPDATED_DATE) AS UPDATED_DATE,
...
public const string SEARCH_PUBLIC_IMAGES_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.ORG_NAME, REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.SUMMERY,
									SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS PULL_COUNT, MAX(REGISTRY_ARTIFACT.UPDATED_DATE) AS UPDATED_DATE,
                                    REGISTRY_ARTIFACT_IMAGE.VISIBILITY FROM REGISTRY_ARTIFACT_IMAGE LEFT JOIN
                                    REGISTRY_ARTIFACT ON REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID=REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID
                                    ...
                                    REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME";
...
public const string SEARCH_IMAGES_FOR_USER_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.ORG_NAME, REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, 
                                    REGISTRY_ARTIFACT_IMAGE.SUMMERY, SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS PULL_COUNT, 
...
public const string UPDATE_IMAGE_QUERY = "UPDATE REGISTRY_ARTIFACT_IMAGE SET DESCRIPTION  = ? WHERE IMAGE_NAME = ? AND 
...
public const string SEARCH_USER_AUTHORED_IMAGES_QUERY_FOR_AUTHENTICATED_USER = "SELECT REGISTRY_ARTIFACT_IMAGE.ORG_NAME, REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, 
                                    ...
                                    REGISTRY_ARTIFACT_IMAGE.ORG_NAME, REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME";
