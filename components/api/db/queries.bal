...
public const string GET_IMAGE_FOR_USER_FROM_IMAGE_NAME = "SELECT REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID,ORG_NAME,
                                    ...
                                    REGISTRY_ARTIFACT_IMAGE.FIRST_AUTHOR, VISIBILITY, SUM(PUSH_COUNT), SUM(PULL_COUNT) FROM 
...
public const string GET_IMAGE_FROM_IMAGE_NAME = "SELECT REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID,ORG_NAME,IMAGE_NAME,
                                    ...
                                    VISIBILITY, SUM(PUSH_COUNT), SUM(PULL_COUNT) FROM REGISTRY_ARTIFACT_IMAGE INNER JOIN REGISTRY_ARTIFACT ON
                                    REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID = REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID WHERE VISIBILITY = \"PUBLIC\" AND
                                    ORG_NAME= ? AND IMAGE_NAME=? GROUP BY REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID";
...
public const string UPDATE_ORG_DESCRIPTION_N_SUMMARY_QUERY = "UPDATE REGISTRY_ORGANIZATION SET DESCRIPTION  = ?,  SUMMARY  = ? WHERE ORG_NAME = ? AND
									ORG_NAME IN (SELECT ORG_NAME FROM REGISTRY_ORG_USER_MAPPING WHERE USER_UUID = ? AND USER_ROLE = \"ADMIN\")";
