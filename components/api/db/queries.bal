...
public const string GET_IMAGE_FROM_IMAGE_NAME = "SELECT REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID,ORG_NAME,IMAGE_NAME,
                                    REGISTRY_ARTIFACT_IMAGE.DESCRIPTION, REGISTRY_ARTIFACT_IMAGE.FIRST_AUTHOR,VISIBILITY, SUM(PUSH_COUNT), 
...
public const string SEARCH_PUBLIC_ORG_IMAGES_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.DESCRIPTION,
									CAST(SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS UNSIGNED) AS PULL_COUNT, MAX(REGISTRY_ARTIFACT.UPDATED_DATE) AS UPDATED_DATE,
...
public const string SEARCH_ORG_IMAGES_FOR_USER_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.DESCRIPTION,
									CAST(SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS UNSIGNED) AS PULL_COUNT, MAX(REGISTRY_ARTIFACT.UPDATED_DATE) AS UPDATED_DATE,
...
public const string SEARCH_PUBLIC_IMAGES_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.ORG_NAME, REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.DESCRIPTION,
									CAST(SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS UNSIGNED) AS PULL_COUNT, MAX(REGISTRY_ARTIFACT.UPDATED_DATE) AS UPDATED_DATE,
                                    REGISTRY_ARTIFACT_IMAGE.VISIBILITY FROM REGISTRY_ARTIFACT_IMAGE LEFT JOIN
                                    REGISTRY_ARTIFACT ON REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID=REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID
...
public const string SEARCH_IMAGES_FOR_USER_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.ORG_NAME, REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, 
                                    REGISTRY_ARTIFACT_IMAGE.DESCRIPTION, CAST(SUM(REGISTRY_ARTIFACT.PULL_COUNT) AS UNSIGNED) AS PULL_COUNT, 
