...
public const string SEARCH_ORG_IMAGES_TOTAL_COUNT = "SELECT COUNT(REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID) AS image_count
                                    FROM REGISTRY_ORGANIZATION LEFT JOIN
                                    REGISTRY_ARTIFACT_IMAGE ON REGISTRY_ORGANIZATION.ORG_NAME=REGISTRY_ARTIFACT_IMAGE.ORG_NAME
                                    WHERE REGISTRY_ORGANIZATION.ORG_NAME = ? 
                                    AND (REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME LIKE ? OR REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME is NULL)
                                    AND (REGISTRY_ARTIFACT_IMAGE.VISIBILITY = \"PUBLIC\" OR REGISTRY_ARTIFACT_IMAGE.VISIBILITY is NULL)
                                    WHERE REGISTRY_ORGANIZATION.ORG_NAME = ?
