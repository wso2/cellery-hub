...
public const string SEARCH_ORG_IMAGES_TOTAL_COUNT = "SELECT COUNT(REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID) 
                                    AS Image_Count FROM REGISTRY_ORGANIZATION LEFT JOIN REGISTRY_ARTIFACT_IMAGE ON 
                                    REGISTRY_ORGANIZATION.ORG_NAME=REGISTRY_ARTIFACT_IMAGE.ORG_NAME WHERE (
                                    (REGISTRY_ORGANIZATION.ORG_NAME = ? ) AND (REGISTRY_ARTIFACT_IMAGE.VISIBILITY = \"PUBLIC\") AND
                                    (REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME LIKE ?))";

public const string SEARCH_ORG_IMAGES_QUERY = "SELECT REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME, REGISTRY_ARTIFACT_IMAGE.DESCRIPTION,
                                    ...
                                    REGISTRY_ARTIFACT ON REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID=REGISTRY_ARTIFACT.ARTIFACT_IMAGE_ID
                                    WHERE REGISTRY_ARTIFACT_IMAGE.ORG_NAME = ?
 ...
 public const string SEARCH_ORG_IMAGES_FOR_USER_TOTAL_COUNT = "SELECT COUNT(REGISTRY_ARTIFACT_IMAGE.ARTIFACT_IMAGE_ID)
                                    AS Image_Count FROM REGISTRY_ORGANIZATION LEFT JOIN
                                    REGISTRY_ARTIFACT_IMAGE ON REGISTRY_ORGANIZATION.ORG_NAME=REGISTRY_ARTIFACT_IMAGE.ORG_NAME
                                    WHERE ((REGISTRY_ORGANIZATION.ORG_NAME = ?) AND (REGISTRY_ARTIFACT_IMAGE.IMAGE_NAME LIKE ?) AND 
                                    (REGISTRY_ORGANIZATION.ORG_NAME IN (SELECT REGISTRY_ORG_USER_MAPPING.ORG_NAME FROM REGISTRY_ORG_USER_MAPPING 
                                    WHERE USER_UUID = ?) OR (REGISTRY_ARTIFACT_IMAGE.VISIBILITY = \"PUBLIC\" OR 
