                ...
                <Dialog open={open} onClose={this.handleClose} aria-labelledby={"form-dialog-title"} fullWidth>
                    ...
                    <DialogContent>
                        <DialogContentText id={"alert-dialog-description"}>
                            If you delete this image version, it will no longer be accessible through Cellery Hub.
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions className={classes.dialogActions}>
                        <Button onClick={this.handleClose}>Cancel</Button>
                        <Button onClick={this.handleDeleteVersion} variant={"outlined"} className={classes.deleteBtn}>
                            Delete
                        </Button>
                    </DialogActions>
                </Dialog>
